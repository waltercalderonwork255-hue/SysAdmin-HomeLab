...
```mermaid
flowchart TD
    START["Daily Backup Schedule"] --> TWOAM["2:00 AM"]
    TWOAM --> DC01BACKUP["DC01 Windows Server Backup"]
    TWOAM --> CLIENT01BACKUP["Client01 rsync backup"]

    START --> TWOFIFTEEN["2:15 AM"]
    TWOFIFTEEN --> CLIENT02BACKUP["Client02 rsync backup"]
```
...
flowchart TD
    ...
    NTFS --> EDRIVE["Assign E: Drive Letter"]
    EDRIVE --> LABEL["Label DC_Backups"]
